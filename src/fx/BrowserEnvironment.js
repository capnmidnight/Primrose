...
var lastPresenting = null;
      var render = () => {
        this.camera.position.set(0, 0, 0);
        this.camera.quaternion.set(0, 0, 0, 1);
        this.audio.setPlayer(this.player.mesh);
        if(lastPresenting !== this.input.VR.isPresenting){
          console.log(this.input.VR.isPresenting);
          lastPresenting = this.input.VR.isPresenting;
        }
      ...
      window.addEventListener("vrexit", exitVR, false);

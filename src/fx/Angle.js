...
Primrose.Angle = ( function ( ) {
  pliny.the.elder.class( "Primrose.Angle", {
    ...
    properties: [
      {name: "degrees", type: Number, description: "get/set the current value of the angle in degrees."},
      {name: "radians", type: Number, description: "get/set the current value of the angle in radians."}
    ]
  } );
  function Angle ( v ) {
    if ( typeof ( v ) !== "number" ) {

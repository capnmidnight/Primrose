...
( function () {
  ...
  pliny.value( "Primrose", {
    ...
    value: "-apple-system, '.SFNSText-Regular', 'San Francisco', 'Roboto', 'Segoe UI', 'Helvetica Neue', 'Lucida Grande', sans-serif"
  } );
  ...
  pliny.value( "Primrose", {
    ...
    value: [ "#FFDFC4", "#F0D5BE", "#EECEB3", "#E1B899", "#E5C298", "#FFDCB2",
  ...
  pliny.value( "Primrose", {
    ...
    description: "A selection of color values that closely match skin colors of people.",
    value: Primrose.SKINS.map( function ( s ) {
...
idiosynchratic, concensus-defying keyboard shortcuts.",
    value: /Macintosh/.test( navigator.userAgent || "" )
  } );
...
the Microsoft Windows operating systems. We have not yet found a use for this flag.",
    value: /Windows/.test( navigator.userAgent || "" )
  } );
...
Google Chrome.",
    value: !!window.opera || navigator.userAgent.indexOf( ' OPR/' ) >= 0
  } );
...
Explorer as the Internet Explorer of the web.",
    value: Object.prototype.toString.call( window.HTMLElement ).indexOf( 'Constructor' ) > 0
  } );
...
features directly in the browser, thanks to the work of Brandon \"Toji\" Jones.",
    value: !!window.chrome && !window.isOpera
  } );
...
a common basis for orientation events.",
    value: window.isiOS || window.isOpera || window.isChrome
  } );
...
the torch on to Safari in all of its many useless incarnations.",
    value: /*@cc_on!@*/false || !!document.documentMode
  } );

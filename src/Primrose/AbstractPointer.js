...
class AbstractPointer extends Primrose.AbstractEventEmitter {
  ...
  addToBrowserEnvironment(env, scene) {
    pliny.method({
      parent: "Primrose.AbstractPointer",
...
AbstractPointer.EVENTS = ["pointerstart", "pointerend", "pointermove", "gazestart", "gazemove", "gazecomplete", "gazecancel", "exit", "enter"];
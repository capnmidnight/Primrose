...
If you're interested in contributing to the framework, we'd love to have you involved. Primrose is open to contributors of all skill levels and we are ready and willing to help beginners work through issues. Please [read the guidelines](https://github.com/capnmidnight/Primrose/blob/master/CONTRIBUTING.md) for contributing before doing so.
...
https://github.com/capnmidnight/Primrose/contributors
...
To get started with Primrose, follow this <a href="https://github.com/capnmidnight/Primrose/wiki/Working-on-Primrose">setup guide</a>.

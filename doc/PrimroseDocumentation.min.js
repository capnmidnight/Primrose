...
pliny.function({
  name: "priv",
  description: "Creates a private scope space for an object that can be retrieved by calling this function again",
  examples: [{
    name: "Basic usage",
    description: "    grammar(\"JavaScript\");\n\
    const priv = require(\"./priv\")(); // note that we call the function right away\n\
    class MyClass {\n\
      priv(this, {\n\
        a: 1,\n\
        b: 2\n\
    ...
    \n\
    myFunc() {\n\
      const _this = priv(this);\n\
      console.log(_this.a, _this.b); // '1, 2'\n\
    }\n\
  }\n\
"
  }]

...
var pliny = ( function ( ) {
  ...
  pliniuses.younger.get = function ( name ) {
    ascertain( name );
    if ( typeof name === "string" || name instanceof String ) {
      return exposeBag( burlapSack, name );
    }
    else if ( name.help ) {
      return name.help;
    }

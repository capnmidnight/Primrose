...
var pliny = ( function ( ) {
  ...
  /**
   * Used in filtering falsey values out of arrays.
   * 
   * @param {any} v - an array element.
   * @return {any} - the input parameter `v`, so it can be evalutated as truthy or falsey.
   */
  function identity ( v ) {
    return v;
  }
  ...
  /**
   * Walks through dot-accessors to retrieve an object out of the documentation database.
   * 
   * @param {String} name - a period-delimited list of object accessors, naming the object we want to access.
   * @returns {Object} - the object we asked for, or undefined, if it doesn't exist.
   */

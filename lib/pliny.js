    ...
    if ( obj ) {
      ...
      if ( typeof obj === "function" ) {
        ...
        while ( !!( match = scriptPattern.exec( script ) ) ) {
          ...
          pliny.theElder[type].apply( null, parameters );
        }
      }
  ...
  var formatters = {
    ...
    console: {
      ...
      format: function ( name ) {
        ...
        if ( obj ) {
          var output = this.shortDescription( obj );
      ...
      formatArrayElement: function ( arrName, n, i ) {
        var s = "\t\t" + i + ": " + this.shortDescription( n );
        if ( n.description ) {
          s += " - "
     ...
     shortDescription: function ( p ) {
       ...
       if ( p.type === "function" || p.type === "method" ) {
         output += "(";
         if ( p.parameters ) {
           output += p.parameters.map( this.shortDescription.bind(this) ).join( ", " );
         }
         output += ")";
       }

...
Primrose.UI.Text.Point.tests = {
  zero: function () {
    var p = new Primrose.UI.Text.Point();
    Assert.areEqual( 0, p.x, "x" );
    Assert.areEqual( 0, p.y, "y" );
  },
  new1: function () {
    var p = new Primrose.UI.Text.Point( 3, 5 );
  ...
  copy1: function () {
    var p = new Primrose.UI.Text.Point( 3, 5 );
    var q = new Primrose.UI.Text.Point( 7, 11 );
    p.copy( q );
    Assert.areEqual( 7, p.x, "x" );
    Assert.areEqual( 11, p.y, "y" );
  },
  clone1: function () {
    var p = new Primrose.UI.Text.Point( 13, 17 );
    var q = p.clone();

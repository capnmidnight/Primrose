...
Primrose.Rectangle.tests = {
  zero: function () {
    var p = new Primrose.Rectangle();
  ...
  new1: function () {
    var p = new Primrose.Rectangle( 3, 5, 7, 11 );
  ...
  copy1: function () {
    var p = new Primrose.Rectangle( 3, 5, 7, 11 );
    var q = new Primrose.Rectangle( 13, 17, 19, 23 );
    p.copy( q );
    Assert.areEqual( 13, p.x, "x" );
    Assert.areEqual( 17, p.y, "y" );
    Assert.areEqual( 19, p.width, "width" );
  ...
  clone1: function () {
    var p = new Primrose.Rectangle( 13, 17, 19, 23 );
    var q = p.clone();
  ...
  toString1: function () {
    var p = new Primrose.Rectangle( 29, 31, 37, 41 );

...
/* global Assert, Primrose */
  ...
  Primrose.UI.Text.Size.tests = {
    zero: function () {
      var p = new Primrose.UI.Text.Size();
      Assert.areEqual( 0, p.width, "width" );
      Assert.areEqual( 0, p.height, "height" );
    },
    new1: function () {
      var p = new Primrose.UI.Text.Size( 3, 5 );
    ...
    copy1: function () {
      var p = new Primrose.UI.Text.Size( 3, 5 );
      var q = new Primrose.UI.Text.Size( 7, 11 );
      p.copy( q );
      Assert.areEqual( 7, p.width, "width" );
      Assert.areEqual( 11, p.height, "height" );
    },
    clone1: function () {
      var p = new Primrose.UI.Text.Size( 13, 17 );
      var q = p.clone();

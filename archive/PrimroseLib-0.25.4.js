...
Primrose.BrowserEnvironment = function () {
  ...
  var BrowserEnvironment = function (_Primrose$AbstractEve) {
    ...
    function BrowserEnvironment(options) {
      ...
      _this.nose = textured(sphere(0.05, 10, 10), skin);
      _this.nose.name = "Nose";
      _this.nose.scale.set(0.5, 1, 1);
...
Primrose.VERSION = "v0.25.4";
console.info("Using Primrose v0.25.4. Find out more at http://www.primrosevr.com");
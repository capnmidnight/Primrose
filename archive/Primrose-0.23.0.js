...
pliny.issue({
  parent: "Primrose.Text.CommandPack",
...
pliny.issue({
  parent: "Primrose.Text.Controls.TextBox",
...
Primrose.VERSION = "v0.23.0";
console.log("Using Primrose v0.23.0. Find out more at http://www.primrosevr.com");